...
resources=["/handle-bars","/stems","/wheelsets","/forks","/seatposts","/saddles","/shifters","/Store/cart.jsp?productID=","/restaurants?sort=asc","/index.html"]
...
maxLimit = random.randint(0,50000)

print ("GENERATING LOGS COUNT=" + str(maxLimit))
